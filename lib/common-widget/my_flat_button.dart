...
class MyFlatButton extends StatelessWidget {
  ...
  MyFlatButton(this.text, this.textColor,
      {this.onTap, this.radius = 8.0, this.disabled = false, this.fillColor, this.horizontalPadding = 10.0, this.verticalPadding = 5.0});
    ...
    return InkWell(
      child: TextButton(
        style: ButtonStyle(
          ...
          //设置按钮内边距
          padding:
          MaterialStateProperty.all(EdgeInsets.symmetric(horizontal: horizontalPadding, vertical: verticalPadding)),
          //设置按钮的大小
