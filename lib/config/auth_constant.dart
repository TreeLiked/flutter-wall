class SharedConstant {
  ...
  static const int VERSION_ID_ANDROID = 27;
  static const int VERSION_ID_IOS = 27;

  static const String VERSION_REMARK_ANDROID = "2.6.0";
  static const String VERSION_REMARK_IOS = "2.6.0";
