class SharedConstant {
  ...
  static const int VERSION_ID_ANDROID = 26;
  static const int VERSION_ID_IOS = 26;

  static const String VERSION_REMARK_ANDROID = "2.5.0";
  static const String VERSION_REMARK_IOS = "2.5.0";
