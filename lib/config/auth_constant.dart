...
class SharedConstant {
  ...
  static const int VERSION_ID_ANDROID = 9;
  static const int VERSION_ID_IOS = 9;
  static const String VERSION_REMARK_ANDROID = "1.3.0";
  static const String VERSION_REMARK_IOS = "1.3.0";
