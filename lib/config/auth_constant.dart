...
class SharedConstant {
  ...
  static const int VERSION_ID_ANDROID = 17;
  static const int VERSION_ID_IOS = 17;

  static const String VERSION_REMARK_ANDROID = "2.4.0";
  static const String VERSION_REMARK_IOS = "2.4.0";
