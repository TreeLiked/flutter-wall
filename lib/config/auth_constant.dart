...
class SharedConstant {
  ...
  static const int VERSION_ID_ANDROID = 23;
  static const int VERSION_ID_IOS = 23;

  static const String VERSION_REMARK_ANDROID = "2.4.6";
  static const String VERSION_REMARK_IOS = "2.4.6";
