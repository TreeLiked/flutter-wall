...
class CircleTweetCreatePage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _CircleTweetCreatePageState();
  }
}

class _CircleTweetCreatePageState extends State<CircleTweetCreatePage> {
  static const String _TAG = "_CircleTweetCreatePageState";
  ...
  void _assembleAndPushTweet() async {
    ...
    if (!hasError) {
      ...
      _baseTweet.anonymous = _contentPrivate;
  ...
  void _reverseAnonymous() {
    setState(() {
      this._contentPrivate = !this._contentPrivate;
    });
  }
                  ...
                  child: Container(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: _canDelete ? Colors.orangeAccent : Colors.transparent,
                      ),
                      child: Text(" 删 除 ",
                          style: pfStyle.copyWith(
                              color: _canDelete ? Colors.white : Colors.grey,
