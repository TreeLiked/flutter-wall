...
class SecondFloorWidget extends StatefulWidget {
  ...
  const SecondFloorWidget(this.linkNotifier, this.secondFloorOpen, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: AnimatedContainer(
        height: _isOpen ? _secondFloor : _refreshState == RefreshMode.inactive ? 0.0 : _pulledExtent,
        color: Colors.white,
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: AnimatedCrossFade(
                ...
                crossFadeState:
                    widget.secondFloorOpen.value ? CrossFadeState.showSecond : CrossFadeState.showFirst,
