  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(slivers: <Widget>[
        ...
        //               //     fontSize: Dimens.font_sp15, color: Colors.grey)),
        //               Text(
        //                 _currentDiscuss.title,
        //                 textAlign: TextAlign.center,
        //                 style: pfStyle.copyWith(
        //                     fontSize: Dimens.font_sp21,
        //                     color: isDark ? Colors.white70 : Colors.lightBlueAccent),
        //               ),
        //               Gaps.vGap10,
        //               ExtendedText("${_currentDiscuss.desc}",
        //                   maxLines: 3,
        //                   softWrap: true,
        //                   textAlign: TextAlign.left,
        //                   selectionEnabled: false, onTap: () {
        //                 ToastUtil.showToast(context, "sakld");
        //               },
        ...
        //                           children: <Widget>[
        //                             Text(".. 详情",
        //                                 style: MyDefaultTextStyle.getTweetBodyStyle(context)
        //                                     .copyWith(color: Colors.blue, fontSize: Dimens.font_sp18))
        //                           ])),
        //                   style: MyDefaultTextStyle.getTweetBodyStyle(context)),
        //               Gaps.vGap10,
        //               Text("157次浏览，78条回复",
