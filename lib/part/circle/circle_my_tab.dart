...
class CircleMyTabView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _CircleMyTabView();
  }
}

class _CircleMyTabView extends State<CircleMyTabView> with AutomaticKeepAliveClientMixin<CircleMyTabView> {
