...
//                          actions: <Widget>[
//                            new CupertinoButton(onPressed: () {}, child: new Text("Cancel")),
//                            new CupertinoButton(onPressed: () {}, child: new Text("Confirm")),
//                          ],
//                        );
//                      });
//                }),
//            new FlatButton(
//                child: new Text("显示android风格的对话框"),
//                onPressed: () {
//                  showDialog(
//                      context: context,
//                      builder: (context) {
